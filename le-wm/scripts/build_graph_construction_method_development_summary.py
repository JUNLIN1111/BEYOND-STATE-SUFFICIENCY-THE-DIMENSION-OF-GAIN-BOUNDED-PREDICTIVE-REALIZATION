...
def main() -> None:
    parser = argparse.ArgumentParser(description="Write the graph-construction method-development summary.")
    parser.add_argument("--output_dir", default="rollout_results/plannable_dim_evidence")
    args = parser.parse_args()

    output_dir = Path(args.output_dir)
    summary_path = output_dir / "summaries" / "graph_construction_method_development.md"
    ...
    print(f"[method_summary] wrote {summary_path}")
